...
```properties
#fastdfs文件服务器
fastdfs.trackerList=116.85.25.106:22122
```

#### 2. 与spring 整合 application-fastdfs.xml
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <context:property-placeholder ignore-unresolvable="true" location="classpath:fastdfs.properties"/>
    ...
    <bean id="trackerConnectionManager" class="com.github.tobato.fastdfs.conn.TrackerConnectionManager">
        ...
        <property name="trackerList">
            <list>
                <value>${fastdfs.trackerList}</value>
            </list>
        </property>
    </bean>
    <!--配置连接池-->
    ...
    <!-- fastdfs 工具包-->
    <bean id="fdfsUtil" class="com.coderman.util.FdfsUtil"/>
</beans>

```

#### 3. 添加文件上传工具类 FdfsUtil.java
